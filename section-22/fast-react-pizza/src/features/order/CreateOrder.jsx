    ...
    <div>
      ...
      <Form method="POST">
        <div>
          ...
          <input
            className="rounded-md border border-stone-200 px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-blue-200 w-full"
            type="text"
            name="customer"
            required
          />
